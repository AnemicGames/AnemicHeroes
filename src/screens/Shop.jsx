                            ...
                            <>
                                ...
                                <div className="grid grid-cols-7 gap-2 w-full">
                                    {buyList.map((item) => {
                                        ...
                                        const onCooldown =
                                            cooldowns[item.id] &&
                                            cooldowns[item.id] > Date.now();
                                        return (
                                            <div
                                                key={item.id}
                                                onClick={() =>
                                                    handleItemClick(item, "buy")
                                                }
                            ...
                            <div className="space-y-2 text-center w-full">
                                ...
                                {selectedItem.statModifiers && (
                                    <ul className="text-xs">
                                        ...
                                        <li>
                                            Speed:{" "}
                                            {selectedItem.statModifiers.speed ||
                                                0}
                                        </li>
                                        <li>
                                            Defense:{" "}
